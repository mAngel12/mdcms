...
<sec:authorize access="hasRole('ADMIN')">
	<li>
		...
		<ul id="submenu-1" class="collapse">
			<li><a href="/admin/config/general"><i class="fa fa-angle-double-right"></i> General</a></li>
			<li><a href="/admin/config/other"><i class="fa fa-angle-double-right"></i> Other Settings</a></li>
		</ul>
	</li>
</sec:authorize>
<sec:authorize access="hasRole('ADMIN')">
