...
<sec:authorize access="hasRole('ADMIN')">
	<li>
		<a data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-cogs"></i> Configuration<i class="fa fa-fw fa-angle-down pull-right"></i></a>
		<ul id="submenu-1" class="collapse">
			<li><a href="/admin/config/general"><i class="fa fa-angle-double-right"></i> General Configuration</a></li>
			<li><a href="/admin/config/template"><i class="fa fa-angle-double-right"></i> Template Configuration</a></li>
		</ul>
	</li>
</sec:authorize>
<sec:authorize access="hasRole('ADMIN')">
	<li>
		<a data-toggle="collapse" data-target="#submenu-2"><i class="fa fa-fw fa-user-plus"></i> Admins and Mods<i class="fa fa-fw fa-angle-down pull-right"></i></a>
...
<li>
	<a data-toggle="collapse" data-target="#submenu-3"><i class="fa fa-fw fa-newspaper-o"></i> Posts<i class="fa fa-fw fa-angle-down pull-right"></i></a>
...
<li>
	<a data-toggle="collapse" data-target="#submenu-4"><i class="fa fa-fw fa-edit"></i> Pages<i class="fa fa-fw fa-angle-down pull-right"></i></a>
...
<li>
	<a data-toggle="collapse" data-target="#submenu-5"><i class="fa fa-fw fa-star"></i> Website<i class="fa fa-fw fa-angle-down pull-right"></i></a>
