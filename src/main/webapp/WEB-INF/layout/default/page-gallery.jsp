...
<html>
<head>
    <title> <t:insertAttribute name="title" /> - ${generalConfig.title} </title>
    ...
    <link rel="stylesheet" href="<s:url value="/resources/default/css/gallery.css" />" >
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <script src="<s:url value="/resources/default/js/gallery.js" />"></script>
